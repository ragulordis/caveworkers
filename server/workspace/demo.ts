...
export type WorkspaceOverview = {
  ...
  messages: Array<{ id: string; sender: "user" | "employee" | "system"; content: string; createdAt: number; messageType: string }>;
...
export function getDemoWorkspace(): WorkspaceOverview {
  return {
    ...
    messages: [
      ...
      { id: "message-3", sender: "employee", content: "I’m tracing the sign-in flow, tenant boundaries, and service dependencies first.", createdAt: now - 180_000, messageType: "progress_report" },
    ],
    tasks: [
